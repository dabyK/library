...
public class StudyGrid2 extends JPanel {
	// 열람실 좌석을 표시하는 그리드 2번(11번부터 20번 자리까지)
	// 로직은 grid1과 동일
	...
	public StudyGrid2(JPanel now, JFrame main, Member m, HashMap<Integer, Study> study, JLabel spare, int count) {
		super();
		this.now = now;
		this.main = main;
		this.m = m;
